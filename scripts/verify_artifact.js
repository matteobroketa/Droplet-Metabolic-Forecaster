...
const checks = [
  ...
  [files.html.includes(`meta name="artifact-commit" content="${manifest.sourceCommit}"`), 'artifact commit metadata mismatch'],
  [files.html.includes(`meta name="artifact-source-commit" content="${manifest.sourceCommit}"`), 'artifact source-commit metadata mismatch'],
  [files.html.includes(`meta name="artifact-release-commit" content="${manifest.releaseCommit}"`), 'artifact release-commit metadata mismatch'],
  [files.html.includes(`meta name="artifact-manifest-version" content="${manifest.manifestVersion}"`), 'artifact manifest-version metadata mismatch'],
  [files.html.includes(`meta name="artifact-manifest-sha256" content="${manifestSha256}"`), 'artifact manifest hash metadata mismatch'],
  [files.html.includes('Metabolic Depletion Forecaster v19'), 'title release mismatch'],
